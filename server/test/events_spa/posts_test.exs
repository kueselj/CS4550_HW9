defmodule EventsSpa.PostsTest do
  ...
  describe "posts" do
    ...
    @valid_attrs %{body: "some body", date: "some date"}
    @update_attrs %{body: "some updated body", date: "some updated date"}
    @invalid_attrs %{body: nil, date: nil}
  ...
  describe "posts" do
    ...
    @valid_attrs %{body: "some body", date: "some date", name: "some name"}
    @update_attrs %{body: "some updated body", date: "some updated date", name: "some updated name"}
